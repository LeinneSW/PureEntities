...
abstract class EntityBase extends Living{
    ...
    public function interactTarget() : bool{
        ++$this->interactDelay;
        if(!$this->canAttackTarget() || !$this->canInteractTarget()){
            return false;
        }
        return true;
    }
    ...
    public function setMotion(Vector3 $motion) : bool{
        $this->getNavigator()->setEnd($this->getNavigator()->getEnd());
        return parent::setMotion($motion); // TODO: Change the autogenerated stub
    }
